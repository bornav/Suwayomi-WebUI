...
export type PartialSettingsType = Settings & {
  ...
  localeOverride?: Maybe<Scalars['String']['output']>;
...
export type PartialSettingsTypeInput = {
  ...
  localeOverride?: InputMaybe<Scalars['String']['input']>;
...
export type SettingsType = Settings & {
  ...
  localeOverride: Scalars['String']['output'];
